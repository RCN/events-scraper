...
var cheerio = require('cheerio'), //jQuery-like HTML manipulation
  ...
  req = Bluebird.promisify(request, {multiArgs: true}),
  _ = require('lodash');
...
//TODO: remove with ES6 migration
...
var parameterizedUrl = eventsSearchUrl + '?state={state}&race={race}&fyear={fyear}&rrfilter={rrfilter}&ajax=2'.format(
  urlParams);
